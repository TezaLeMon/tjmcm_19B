...
#define input_data "input5.txt"
#define output_data "outdata5.txt"
#define output_gant "output5.txt"

const int parallel_arr[ordernumber] = { parallel_0,parallel_e };
/*************需要手动调节的部分**************/
